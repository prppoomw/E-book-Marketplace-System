        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-2 col-md-5">
                    ...
                    <?php
                    $username = $_SESSION['username'];
                    $sql="SELECT * FROM ebook WHERE userid = '$username'";
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <ul class="product__item__pic__hover">
                                        <li><a href="deletebookw.php?id=<?=$row['bookid']?>"><i class="fa fa-trash"></i></a></li>
                                    </ul>
                                </div>
                                <div class="product__item__text">
                                    <h6><a href="editBookWriter.php?id=<?=$row['bookid']?>"><?=$row['bookname']?></a></h6>
                                    <h5><?=$row['price']?> บาท</h5>
                                </div>
                            </div>
                        </div>
