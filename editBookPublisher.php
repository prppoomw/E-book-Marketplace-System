...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                <li class="active"><a href="homePublisher.php">หนังสือของคุณ</a></li>
...
<form method = "POST" action = "updatebookp.php" enctype = "multipart/form-data">
          ...
          <div class="row g-0">
            <div class="col-xl-12">
              <div class="card-body p-md-5 text-black">
                ...
                <select name = "userid"  class="form-control form-control-lg" required>
                  <?php
                    ...
                    while($row=mysqli_fetch_array($hand)){
                      $pwrter = $row['userid'];
                  ?>
                    <option value = "<?=$row['userid']?>" <?php if($wrter == $pwrter) { echo "selected=selected"; } ?>><?=$row['userid']?></option>
                  <?php
                    }
                    mysqli_close($conn);
                  ?>
                ...
                <button type="button" class="btn btn-danger" onclick="window.location.href='homePublisher.php'">ยกเลิก</button>
