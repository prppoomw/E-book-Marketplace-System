                ...
                <div class="col-lg-12">
                    <div class="shoping__cart__table">
                        <table>
                            <thead>
                                <tr>
                                    <th class="shoping__product">หนังสือ</th>
                                    <th>ราคา</th>
                                    <th>จำนวน</th>
                                    <th></th>
                                </tr>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="shoping__cart__item__close">
                                        <a href="deletefromcart.php?id=<?=$row['bookid']?>"><span class="icon_close"></span></a>
                                    </td>
                                </tr>
                            <?php    
                            }
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="shoping__cart__btns">
                        <a href="homeReader.php" class="primary-btn cart-btn">เลือกหนังสือต่อ</a>
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <div class="shoping__checkout">
                        <h5>ตะกร้าทั้งหมด</h5>
                        <ul>
                            <li>ราคาทั้งหมด <span><?php echo empty($prices) ? 0 :array_sum($prices); ?> บาท</span></li>
                        </ul>
                        <?php if (empty($prices)) { ?>
                            <a href="" class="primary-btn" disabled>ชำระเงิน</a>
                        <?php } else { ?>
                            <a href="buy.php" class="primary-btn">ชำระเงิน</a>
                        <?php } ?>
