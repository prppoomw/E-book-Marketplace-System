...
$sql="SELECT * FROM reader WHERE userid = '$id'";
...
<body>
<form method = "POST" action = "udr.php">
          ...
          <div class="row g-0">
            ...
            <div class="col-xl-6">
              <div class="card-body p-md-5 text-black">
                <h3 class="mb-5 text-uppercase">แก้ไขข้อมูล (สำหรับนักอ่าน)</h3>
                ...
                <div class="form-outline mb-4">
                  <input type="text" id="form3Example97" name = "creditcard" class="form-control form-control-lg" value = "<?=$row1['creditcard']?>"/>
                  <label class="form-label" for="form3Example97">CreditCard</label>
                </div>

                <div class="d-flex justify-content-end pt-3">
                  <button type="button" class="btn btn-danger" onclick="window.location.href='homeReader.php'">ย้อนกลับ</button>
