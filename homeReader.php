                        ...
                        <div class="sidebar__item">
                            <div class="latest-product__text">
                                ...
                                <div class="latest-product__slider owl-carousel">
                                    ...
                                    ?>
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic">
                                                <img src="img/<?=$row['bookcover']?>" width="200" height="500" alt="">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6><?=$row['bookname']?></h6>
                                                <span><?=$row['price']?> บาท</span>
                                            </div>
                                        </a>
                                    <?php
                                    }
                                    ...
                                    <div class="latest-prdouct__slider__item">
                                    <?php
                                    $sql="SELECT * FROM ebook LIMIT 4,3";
                                    $hand= mysqli_query($conn,$sql);
                                    while($row=mysqli_fetch_array($hand)){
                                    ?>
                                        <a href="#" class="latest-product__item">
                                ...
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            <h5><a href="#"><?=$row['bookname']?></a></h5>
                                            <div class="product__item__price"><?php
                                                $discount = $row['price'] - ($row['price']*20)/100;
                                                echo $discount . ' บาท';
                                                ?> <span><?=$row['price']?> บาท</span>
                                            </div>
                                        </div>
