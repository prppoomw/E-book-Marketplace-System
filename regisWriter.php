...
<body>
<form method = "POST" action = "insertWriter.php">
          ...
          <div class="row g-0">
            ...
            <div class="col-xl-6">
              <div class="card-body p-md-5 text-black">
                <h3 class="mb-5 text-uppercase">ลงทะเบียนบัญชีผู้ใช้ (สำหรับนักเขียน)</h3>
                ...
                <div class="row">
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                    <input type="text" id="form3Example99" name = "publisherid" class="form-control form-control-lg" required/>
                    <label class="form-label" for="form3Example99">PublisherID</label>
                    </div>
                  </div>
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                    <input type="text" id="form3Example97" name = "receivemethod" class="form-control form-control-lg" required/>
